...
<p align = "center">Итого мы получаем 36 программ, каждая из которых является решением соответсвующей задачи</p>

<h1 align = "center">Вывод</h1>
<p>По итогу проделанной лабораторной работы, я узнал о том, что такое HTML и использовал эти знания в решении задач.</p>
